...
RUN dotnet build "./dekoeky.hello-world.tests.csproj" -c $BUILD_CONFIGURATION -f net6.0 -o /app/build

FROM build AS publish
ARG BUILD_CONFIGURATION=Release
RUN dotnet publish "./dekoeky.hello-world.tests.csproj" -c $BUILD_CONFIGURATION -f net6.0 -o /app/publish /p:UseAppHost=false
